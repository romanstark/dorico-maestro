...
* Connect over IPv4 127.0.0.1 (avoid localhost due to Windows IPv6 ::1 loopback)
* Session-token handshake, including the initial approval prompt
* FIFO response correlation (Dorico replies lack requestId fields)
* Merged snapshot management of pushed status messages
"""
